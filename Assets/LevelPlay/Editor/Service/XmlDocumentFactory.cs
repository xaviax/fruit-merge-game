...
{
    class XmlDocument : IXmlDocument
    {
        readonly System.Xml.XmlDocument m_XmlDocument = new System.Xml.XmlDocument();
        ...
        {
            return m_XmlDocument.CreateElement(name);
        }
    ...
    class XmlDocumentFactory : IXmlDocumentFactory
    {
