...
namespace Unity.Services.LevelPlay.Editor
{
    ...
    class PackageRegistrationEvent
    {
    ...
    class UpmLevelPlaySdkInstaller : ILevelPlaySdkInstaller
    {
        readonly SdkInstaller m_SdkInstaller;
        readonly ILevelPlayLogger m_Logger;

        internal UpmLevelPlaySdkInstaller(ILevelPlayLogger logger, ILevelPlayNetworkManager levelPlayNetworkManager)
        {
        ...
        internal async Task OnRegisteredPackages(PackageRegistrationEvent packageRegistrationEvent)
        {
            var addedLevelPlayPackages = packageRegistrationEvent.added.ToList()
                .Where(packageInfo => packageInfo.name == Constants.k_PackageName);
