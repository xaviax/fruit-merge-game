...
namespace Unity.Services.LevelPlay.Editor.IntegrationManager.UIComponents
{
    class LevelPlaySdkComponent : IDrawable
    {
        ...
        public void Draw()
        {
            ...
            GUILayout.Label("A bundled SDK that includes Unity LevelPlay mediation, the Unity Ads network, and the ironSource Exchange.", infoTextStyle);
            GUILayout.Space(8);
            ...
            GUILayout.Label("ironSource Exchange", ironSourceTextStyle);
            GUI.enabled = true;
