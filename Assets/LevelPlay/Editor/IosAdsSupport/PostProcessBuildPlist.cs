...
{
    class PostProcessBuildPlist : IPostprocessBuildWithReport
    {
        public int callbackOrder => 0;
        const string k_SkAdNetworkIdentifier = "SKAdNetworkIdentifier";
        const string k_SkAdNetworkItems = "SKAdNetworkItems";
