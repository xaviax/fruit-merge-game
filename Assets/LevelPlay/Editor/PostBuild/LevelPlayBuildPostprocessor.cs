...
{
    public class LevelPlayBuildPostprocessor
    {
        ILevelPlayLogger _logger;

        LevelPlayBuildPostprocessor() : this(EditorServices.Instance.LevelPlayLogger)
        {
        }

        internal LevelPlayBuildPostprocessor(ILevelPlayLogger logger)
        {
            _logger = logger;
        }
        ...
        {
            var postProcessor = new LevelPlayBuildPostprocessor();
